...
class ManageDoctor extends Component {
    ...
    handleChangeSelect = async (selectedDoctor) => {
        ...
        if (res && res.errCode === 0 && res.data && res.data.Markdown) {
            ...
            let addressClinic = '', nameClinic = '', note = '', paymentId = '', specialtyId = '', clinicId = '', priceId = '', provinceId = '', selectedPayment = '', selectedPrice = "", selectedProvince = "", selectedSpecialty = "", selectedClinic = ""
                ...
                <div className='more-infor form-group' >
                    ...
                    <div className='more-infor-extra row'>
                        ...
                        <div className='col-4 form-group'>
                            ...
                            <input className='form-control' onChange={(event) => { this.handleOnchangeText(event, 'addressClinic') }} value={this.state.addressClinic}></input>
                        </div>
                        <div className='col-4 form-group'>
